...
const Testimoni = () => {
    const testimonials = [
        {
            avatar: "https://media.discordapp.net/attachments/1125528451428917389/1125770277830271026/image.png?width=671&height=671",
            name: "Bapak Yanto",
            title: "Pengusaha",
        ...
        {
            avatar: "https://media.discordapp.net/attachments/1125528451428917389/1125768935690752000/female.png?width=671&height=671",
            name: "Ibu Dewi",
            title: "Karyawan",
        ...
        {
            avatar: "https://media.discordapp.net/attachments/1125528451428917389/1125769920072912997/image.png?width=671&height=671",
            name: "Pak Ahmad",
            title: "Wiraswasta",
                ...
                <div className="relative z-10 max-w-screen-xl mx-auto px-4 md:px-8">
                    <div className="max-w-xl sm:text-center md:mx-auto">
                        ...
                        <p className="mt-3 text-gray-600">
                            Kesaksian Kepuasan Pelanggan Layanan Perbaikan Mobil
                            Kami
                        </p>
                    </div>
                    <div className="mt-12">
